...
import com.hospital.management.hospitalmanagementsystem.shedule.availability.mapper.DoctorAvailabilityMapper;
import com.hospital.management.hospitalmanagementsystem.shedule.availability.repository.DoctorAvailabilityRepository;
...
public class DoctorAvailabilityServiceImpl implements DoctorAvailabilityService {
    ...
    @Override
    @Transactional
    public AvailabilityResponseDTO updateAvailability(Long id,
                                                      AvailabilityRequestDTO dto) {

        DoctorAvailability availability = getAvailabilityOrThrow(id);

        getDoctorForScheduleUpdate(availability.getDoctor().getId());
