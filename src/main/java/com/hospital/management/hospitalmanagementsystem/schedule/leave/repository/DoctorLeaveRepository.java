package com.hospital.management.hospitalmanagementsystem.schedule.leave.repository;
...
public interface DoctorLeaveRepository extends JpaRepository<DoctorLeave, Long> {
    ...
    @EntityGraph(attributePaths = {"doctor", "reviewer"})
    @Query("SELECT l FROM DoctorLeave l WHERE l.id = :id")
    Optional<DoctorLeave> findByIdForUpdate(@Param("id") Long id);
